var MisApp = angular.module('misapp', ['ui.router', 'ui.grid', 'ngTouch', 'ui.grid.edit'
	, 'ui.grid.rowEdit', 'ui.grid.cellNav', 'ui.grid.pagination', 'ui.bootstrap', 'ui.calendar']);
MisApp.config(function($stateProvider, $urlRouterProvider, $httpProvider) {
    ...
    .state('main', {
		...
		resolve: {
			tableData: function($stateParams, PlanService, customtable, UserService, $q, ServiceService, TrainService, ActionService) {
