...
public class PinyinUtil {
	 ...
	 * @return 字符串形式返回
	 */
	public static String getHeadStrByString(String src, boolean isCapital, String separator){
		return stringArrayToString(getHeadByString(src, isCapital), separator);
	}
	
	public static void main(String[] args) {
//		System.out.println(PinyinUtil.stringArrayToString(getHeadByString("我的心肝爱上"),"-"));
//		System.out.println(PinyinUtil.stringArrayToString(getHeadByString("山跑", false), "-"));
//		System.out.println(PinyinUtil.getHeadStrByString("山炮", false, "-"));
		System.out.println(PinyinUtil.hanziToPinyin("王明", ""));
	}
